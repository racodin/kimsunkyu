export default class Ease {
  ...
  static easeLinear(t, b, c, d) {
    // (500, 0, 100, 1000)
    // start + ( end - start ) / ( currentTime * totalTime )
    // b + ( c - b ) / ( t * d )
    // 0 + ( 100 - 0 ) * ( 500 / 1000 )
    return b + (c - b);
  }
  ...
  static easeInQuad(t, b, c, d) {
    // (500, 0, 100, 1000)
    // end * ( currentTime = currentTime / totalTime ) * currentTime + start
    // c * ( t = t / d ) * t + b
    // 100 * ( 500 / 1000 ) * ( 500 / 1000 ) + 0
    return c * (t /= d) * t + b;
  }

  static OutQuad({ start = 0, end = 0, speed = 0 }) {
